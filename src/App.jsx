...
function App() {
  ...
  useEffect(() => {
    let fetchdb = async()=>{
      let fetchdata = await fetch("http://localhost:3000/fetchdb")
    ...
    let fetfun = async () => {
      await fetch("http://localhost:3000", {
        method: "POST", headers: {
          ...
          "State-Object": JSON.stringify(todos),
        ...
        <div className="container w-3/4 mx-auto my-5 px-10 py-5 bg-purple-400 h-[80vh] rounded-lg">
          ...
          <div className="upper my-5">
            <div className="addtodo flex  gap-4 items-center">
              ...
              <input className='w-2/3 p-1' type="text" name="todoinp" id="todoinp" value={todo} onChange={handelChange} />
